...
var rawDataLoader = function () {
    THREE.Loader.call( this, false );

    this.withCredentials = false;
};

rawDataLoader.prototype = Object.create(THREE.Loader.prototype);

rawDataLoader.prototype.load = function(url, callback) {
    this.onLoadStart();
    this.loadAjaxJSON(this, url, callback);
};

rawDataLoader.prototype.loadAjaxJSON = function(context, url, callback) {
